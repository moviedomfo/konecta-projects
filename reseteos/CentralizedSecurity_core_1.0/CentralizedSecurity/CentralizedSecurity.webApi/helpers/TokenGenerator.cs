...
namespace CentralizedSecurity.webApi.helpers
{
    public class TokenGenerator
    {
        ...
        public static  string GenerateTokenMeucci(EmpleadoReseteoBE emmpleadoBE)
        {
            ...
            var key = Encoding.ASCII.GetBytes(apiAppSettings.apiConfig.api_secretKey);
            ...
            var tokenDescriptor = new SecurityTokenDescriptor
            {
                ...
                Expires = DateTime.UtcNow.AddMinutes(Convert.ToInt32(apiAppSettings.apiConfig.api_expireTime)),
        ...
        public static string GenerateTokenJwt_LDAP(string userName, ActiveDirectoryUser aDUser, List<ActiveDirectoryGroup> groups)
        {
            ...
            var secretKey = apiAppSettings.apiConfig.api_secretKey;
            // audiencia quien genera el tocken
            var audienceToken = apiAppSettings.apiConfig.api_audienceToken;
            //identifica quien consume y uusa el tocken : El cliente
            var issuerToken = apiAppSettings.apiConfig.api_issuerToken;
            //hora de caducidad a partir de la cual el JWT NO DEBE ser aceptado para su procesamiento.
            var expireTime = apiAppSettings.apiConfig.api_expireTime;
