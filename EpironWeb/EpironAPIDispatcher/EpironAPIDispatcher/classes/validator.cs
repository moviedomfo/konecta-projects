...
namespace EpironAPI.classes
{
    ...
    public class Validaciones
    {
        ...
        //{
        //    DataTable dtGuidSessionValido,   dtUser, dtPermisos, dtUsersEnabled, dtInstanceApp = new DataTable();//dtLogSession
        ...
        //        idEvento = dtError.EventResponseId;
        ...
        //                                                                                AccesoDatos.AuditTrailSessionDet_i(Par_AuditTrailSessionId, dtError.EventResponseId, dtError.toJson(), xmlRequest);
        ...
        //                                                                ////dsXmlError.Tables[0].Rows.Add(rowxmlError);
        //                                                                ////txtError = ToStringAsXml(dsXmlError);
        //                                                                AccesoDatos.AuditTrailSessionDet_i(Par_AuditTrailSessionId, idEvento, dtError.toJson(), xmlRequest);
        ...
        //                                        dtError.EventResponseText = dtError.EventResponseText  + " " + wCurrentGuid.ToString();
        //                                        //dtError.TableName = "Error";
