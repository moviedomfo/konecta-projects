...
export class UserTasksComponent implements OnInit {
  ...
  tasks = [
    new UserTask({taskId:0, tittle : "Realiza examen físico al paciente Moreno",  completedPercent : 50,descripción:'', createdDate: this.d,priority : "low"}),
    new UserTask({taskId:1, tittle : "Planifica el estudio del paciente y determina el tratamiento a seguir.",  completedPercent : 50,descripción:'', createdDate: this.d,priority : "medium"}),
    new UserTask({taskId:2, tittle : "Visitas domiciliarias hoy 13:30",  completedPercent : 50,descripción:'Visita a Alan Mcdonalls', createdDate: this.d,priority : "hight"}),
  ];
  constructor() { }
