...
namespace EpironAPI.classes
{
    public class AccesoDatos
    {
            ...
            /// </returns>
            public static DataTable Event_s_ByTag(string Par_EventTag)
            {
            ...
            ///</returns>
            public static DataTable AuditTrailLogin_i(Guid Par_AuditTrailLoginParentGUID, Guid Par_AuditTrailLoginAppInstanceGUID, int Par_EventId, DateTime Par_AuditTrailLoginEndDate, string Par_AuditTrailLoginHost, string Par_AuditTrailLoginIP, string Par_AuditTrailLoginResponse, string Par_AuditTrailLoginRequest)
            {
                ...
                NewRow["GUID"] = Par_AuditTrailLoginGUID;
                NewRow["AuditTrailLoginId"] = AuditTrailLoginId;
            ...
            public static Error EventResponse_s_ByInternalCode(int Par_EventResponseInternalCode)
        {
            ...
            /// </returns>
            public static DataTable AuditTrailLogin_s_ByAuditTrailLoginGUID_Valid(Guid Par_AppInstanceGUID, Guid Par_AuditTrailLoginGUID)
            {
            ...
            /// <returns></returns>
            public static DataTable AuthenticationTypeApplicationInstanceUser_s_Valid(string Par_UserName, Guid Par_AppInstanceGUID, Guid Par_AutTypeGUID)
            {
            ...
            /// <returns></returns>
            public static DataTable AuthenticationTypeApplicationInstanceUser_s_Valid_Domain(string Par_UserName, Guid Par_AppInstanceGUID, Guid Par_AutTypeGUID, Guid Par_DomainGUID)
            {
            ...
            /// <returns></returns>
            public static DataTable AuthenticationType_s_ByGUID(Guid Par_AutTypeGUID)
            {
            ...
            /// <param name="Par_DomainGUID">GUID del dominio</param>
            /// <returns></returns>
            public static DataTable Domain_s_ByGUID(Guid Par_DomainGUID)
            {
            ...
            /// <param name="Par_ApplicationInstanceGUID">GUID de instancia de la aplicación</param>
            /// <returns></returns>
            public static DataTable AuthenticationTypeUser_s_MembershipUserID(int UserId, int AuthenticationTypeId)
            {
            ...
            public static DataTable TransaccionSession(int Par_EventId, int Par_UserId, int Par_AuthenticationTypeId, string Par_AuditTrailSessionResponse, DateTime Par_AuditTrailSessionEndDate, int Par_DomainId, Guid Par_AuditTrailLoginParentGUID, Guid Par_AuditTrailLoginAppInstanceGUID, string Par_AuditTrailLoginHost, string Par_AuditTrailLoginIP, string Par_AuditTrailLoginResponse, string Par_AuditTrailLoginRequest, int IdEventUserOk, DateTime Par_AuditTrailLoginEndDateUserAuthentic)
            {
                ...
                connection.ConnectionString = Datos.Configuracion.Conn;
                connection.Open();
