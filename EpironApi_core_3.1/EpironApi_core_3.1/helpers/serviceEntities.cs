...
namespace epironApi.webApi
{
            ...
            if (apiAppSettings.serverSettings.apiConfig.proxyEnabled)
            {
                var proxy = new WebProxy()
                {
                    ...
                    Credentials = new NetworkCredential(
                        userName: apiAppSettings.serverSettings.apiConfig.proxyUser,
                        password: apiAppSettings.serverSettings.apiConfig.proxyPassword)
                };
            ...
            if (ex.InnerException != null)
            {
                ...
                if (ex.InnerException.GetType() == typeof(System.Net.Sockets.SocketException))
                {
                    ...
                    if (e.ErrorCode == 10060)
                        msg = apiAppSettings.serverSettings.apiConfig.api_bootApiHoock + " no es accesible " + Environment.NewLine + msg;
                }
    ...
    public class apiConfig
    {
        ...
        public string api_bootApiHoock { get; set; }
